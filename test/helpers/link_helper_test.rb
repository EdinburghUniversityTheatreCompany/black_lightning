...
class LinkHelperTest < ActionView::TestCase
  ...
  test "get_link with index" do
    expected_link = '<a class="btn btn-secondary" title="Show All Fault Reports" href="/admin/fault_reports"><span class="no-wrap"><i class="fa-solid fa-th-list" aria-hidden=”true”></i> Show All</span> Fault Reports</a>'
  ...
  test "get_link with new" do
    expected_link = '<a class="btn btn-primary" title="New Maintenance Debt" href="/admin/maintenance_debts/new"><span class="no-wrap"><i class="fa-solid fa-plus" aria-hidden=”true”></i> New</span> Maintenance Debt</a>'
  ...
  test "get_link with edit with no_wrap" do
    ...
    expected_link = '<a class="btn btn-secondary no-wrap" title="Edit" href="/admin/staffings/1/edit"><span class="no-wrap"><i class="fa-solid fa-pencil-alt" aria-hidden=”true”></i> Edit</span></a>'
