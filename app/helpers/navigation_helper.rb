module NavigationHelper
  ...
  def admin_navbar_items
    ...
    children << { title: "Find/Edit Expense", path: find_admin_reimbursements_expense_edits_path, fa_icon: "fa-pen-to-square" } if can? :manage, :reimbursements_finance
    ...
    children << { title: "Setup guide", path: admin_reimbursements_help_path, fa_icon: "fa-circle-question" } if can? :manage, :reimbursements_finance
