...
class DebtMailer < ApplicationMailer
  ...
  def mail_debtor(user, new_debtor, debt_moment: nil)
    @user = user
    ...
    @debt_moment = debt_moment || Admin::Debt.users_oldest_debt(@user) || "|||ERROR: No moment of debt found. Please email it@bedlamtheatre.co.uk|||"
