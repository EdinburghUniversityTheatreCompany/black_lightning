...
class Admin::PermissionsController < AdminController
  ...
  def set_models_and_roles
    ...
    @models = (ApplicationRecord.descendants + [ Admin::Debt, Season, Doorkeeper::Application ] - [ MarketingCreatives::CategoryInfo, Admin::Proposals::Proposal, OpportunityRole, Reimbursements::BatchAttempt ]).uniq
