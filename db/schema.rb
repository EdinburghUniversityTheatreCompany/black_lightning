...
ActiveRecord::Schema[8.1].define(version: 2026_09_05_181000) do
  ...
  create_table "climate_sensors", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.boolean "in_crypt", default: false, null: false
  ...
  create_table "news", id: :integer, charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["show_public", "publish_date"], name: "index_news_on_show_public_and_publish_date"
  ...
  create_table "reimbursements_eusa_actuals", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["offset_of_id"], name: "index_reimbursements_eusa_actuals_on_offset_of_id"
    t.index ["period"], name: "index_reimbursements_eusa_actuals_on_period"
    t.index ["reconciliation_status"], name: "index_reimbursements_eusa_actuals_on_reconciliation_status"
  ...
  create_table "reimbursements_financial_years", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.index ["key"], name: "index_reimbursements_financial_years_on_key", unique: true
